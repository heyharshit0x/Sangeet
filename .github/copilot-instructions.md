# Copilot Instructions for Sangeet Music

## Project Overview

Sangeet Music is a cross-platform music streaming application built with Flutter, supporting Android, Windows, and Linux. The app streams music from YouTube/YouTube Music without requiring login or showing advertisements.
